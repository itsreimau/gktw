    ...
    get quoted() {
        ...
        return {
            ...
            key: {
                ...
                fromMe: senderJid && this.core.user.id ? baileys.areJidsSameUser(Functions.decodeJid(senderJid), Functions.decodeJid(this.core.user.id)) : false,
                id: msgContext.stanzaId
            },
            senderJid,
            decodedSenderJid: Functions.decodeJid(senderJid),
            pushName: Functions.getPushname(senderJid) || null,
            media: {
