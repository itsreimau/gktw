...
class Ctx {
    ...
    get quoted() {
        ...
        return {
            content: Functions.getContentFromMsg(msgContext.quotedMessage) || null,
            message,
            ...
            media: {
                toBuffer: async () => await this.getMediaMessage(message, "buffer"),
                toStream: async () => await this.getMediaMessage(message, "stream")
            }
        };
    }
