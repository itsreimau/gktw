...
class Ctx {
    ...
    get quoted() {
        ...
        return {
            content: Functions.getContentFromMsg(quotedMsg) || null,
            message,
            ...
            key: {
                remoteJid: this.id,
                participant: this.id.endsWith("@g.us") ? (this._msg.key.participant ? Functions.decodeJid(this._msg.key.participant) : null) : null,
                fromMe: this._msg.key.participant && this.core.user.id ? baileys.areJidsSameUser(Functions.decodeJid(this._msg.key.participant), Functions.decodeJid(this.core.user.id)) : false,
                id: msgContext.stanzaId
            };
            senderJid,
            decodedSenderJid: Functions.decodeJid(senderJid),
            pushName: Functions.getPushname(this._msg.key.participant || this.id) || null;
            media: {
