    ...
    async launch() {
        ...
        if (this.usePairingCode && !this.core.authState.creds.registered) {
            ...
            try {
                ...
                this.consolefy.error("Invalid phone number format");
                this.consolefy.resetTag();
                return;
            }

            setTimeout(async () => {
                const code = this.customPairingCode ?
                    await this.core.requestPairingCode(this.phoneNumber, this.customPairingCode) :
                    await this.core.requestPairingCode(this.phoneNumber);
